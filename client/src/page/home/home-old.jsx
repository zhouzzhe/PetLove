...
function HomeMain() {
  ...
  //   document.head.appendChild(link);
    ...
    //       goTopButton.style.display = "block"; // 显示按钮
    //     } else {
  ...
  return (
      ...
      <div className="DownAll">
        ...
        <div className="section">
          ...
          <div className="d-flex flex-wrap justify-content-center">
            ...
            <a
              href="/walking"
              className="mx-3 serveBox d-flex flex-wrap justify-content-center align-items-center"
            >
    ...
    //         GO TOP
    //         <br />
    //         <img className="text-center" src="image/goTop.svg" alt="" />
    //       </a>
    //     </div>
    //     {/* goTop */}
    //     {/* 輪播圖 */}
    ...
    //             <div className="carousel-item active store-item w-auto justify-content-center align-items-center">
    //               <img src="/image/輪播圖1.png" className="d-block store-img" />
    //             </div>
    ...
    //       <div className="d-flex justify-content-center">
    //         <p className="title ld ld-jump">服務項目</p>
    ...
    //         <div className="d-flex justify-content-center" id="step">
    //           <p className="title ld ld-jump">流程說明</p>
    //         </div>
    //         <div className="d-flex flex-wrap justify-content-center">
    //           {/* 流程步驟1 */}
    //           <div className="mx-3 stepBox d-flex flex-wrap justify-content-center align-items-center">
    ...
    //             <img className="ld ld-bounce" src="../img/join.svg" />
    //           </div>
